   ...
   <div class="container">
      <div class="panel panel-default">
         ...
         <div class="panel-body">
            ...
            <form role="form" action="CSRF.php" method="POST">
                  ...
                  '<div class="item col-xs-4">
                     <div class="thumbnail">
                        ...
                        <div class="buttons-edit">
                           <a class="btn btn-default btn-sm" href="CSRF.php?command=edit&id=' . $product['id'] . '">Edit</a>
                           <a class="btn btn-default btn-sm" href="CSRF.php?command=delete&id=' . $product['id'] . '">Delete</a>
                        </div>
                        <div class="caption">
